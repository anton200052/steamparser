...
public class ParsingTaskManager
{
    ...
    public ParsingTaskManager(ParsingStatus statusManager, SeleniumSteamParsingService seleniumSteamParsingService, TelegramMessagesSender messagesSender, Logger logger, SeleniumProperties seleniumProperties, ItemQueueManager<SteamItem> steamItemQueueManager)
    {
    ...
    public void startParsingProcess()
    {
        ...
        int threads = seleniumProperties.getThreadsValue();
